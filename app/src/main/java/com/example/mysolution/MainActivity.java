...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        hiroty=(Button) findViewById(R.id.button);
        ...
        hiroty.setOnContextClickListener(new View.OnContextClickListener() {
            @Override
       ...
       /* hiroty.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                String str =numbers.getText().toString();
                String[] tmp = str.split(" ");
    ...
    public void print(){
      ...
      for(int i= solution.size()-1 ;i>=0;i++){
          sum.append(solution.get(i)).append("\n");
      }
